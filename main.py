...
class ChaosManagerApp:
    def __init__(self, root):
        ...
        self.log_text = None
        self.preview_data = []  # Speichert geplante Verschiebe-Aktionen
    ...
    def get_category(self, filename):
        """Die 'Intelligenz' des Sortierers"""
        name_lower = filename.lower()
        ext = os.path.splitext(filename)[1].lower()

        # 1. Priorität: Keywords (Smart Sort)
    ...
    def _analyze_thread(self, path):
        ...
        try:
            for item in os.listdir(path):
                ...
                # Wir ignorieren Ordner und versteckte Dateien
            ...
            # Ergebnis anzeigen
            if files_found == 0:
                self.root.after(0, lambda: self.log("Der Ordner ist bereits leer oder enthält nur Unterordner.",
                                                    "warning"))
                return
            ...
            self.root.after(0, lambda: self.log("Analyse abgeschlossen. Drücke 'Aufräumen Starten' um fortzufahren.",
                                                "header"))
    ...
    def _cleanup_thread(self):
        ...
        for item in self.preview_data:
            try:
                ...
                # Zieldateiname berechnen (Konflikte vermeiden)
                ...
                # Kleines Delay für den Effekt (kann man entfernen für Speed)
                # time.sleep(0.01)
